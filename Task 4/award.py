...
try:
  ...
  if time_swimming > 0 and time_cycling > 0 and time_running > 0:
    ...
    raise Exception("One or more of swimming, cycling or running times is/are invalid.")
except ValueError:
  print("Invalid input")

#if all times entered conform with the requirement (number and more than zero)
if valid_time_input:
